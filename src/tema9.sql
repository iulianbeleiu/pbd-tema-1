...
3.
INSERT INTO `evidenta_calculatoare_licente`.`angajat` (`nume`, `prenume`, `nr_legitimatie`) VALUES ('popa', 'ion', '123456');
INSERT INTO `evidenta_calculatoare_licente`.`angajat` (`nume`, `prenume`, `nr_legitimatie`) VALUES ('adam', 'gheorghe', '123457');
INSERT INTO `evidenta_calculatoare_licente`.`angajat` (`nume`, `prenume`, `nr_legitimatie`) VALUES ('Pop', 'george', '123458');


INSERT INTO `evidenta_calculatoare_licente`.`calculator` (`descriere`, `nr_inventar`) VALUES ('Pentium 4', '1000');
INSERT INTO `evidenta_calculatoare_licente`.`calculator` (`descriere`, `nr_inventar`) VALUES ('Athlon', '1001');
INSERT INTO `evidenta_calculatoare_licente`.`calculator` (`descriere`, `nr_inventar`) VALUES ('Celeron', '1002');
INSERT INTO `evidenta_calculatoare_licente`.`calculator` (`descriere`, `nr_inventar`) VALUES ('Celeron', '1003');


INSERT INTO `evidenta_calculatoare_licente`.`licenta` (`tip`, `produs`, `producator`, `valoare`, `document`) VALUES ('OEM', 'Wndows XP', 'Microsoft', 500, '34/20.01.2006');
INSERT INTO `evidenta_calculatoare_licente`.`licenta` (`tip`, `produs`, `producator`, `valoare`, `document`) VALUES ('Retail', 'Office XP', 'Microsoft', 1200, '234/11.01.2007');
INSERT INTO `evidenta_calculatoare_licente`.`licenta` (`tip`, `produs`, `producator`, `valoare`, `document`) VALUES ('Free', 'openOffice', 'XXX', 0, 'NA');
INSERT INTO `evidenta_calculatoare_licente`.`licenta` (`tip`, `produs`, `producator`, `valoare`, `document`) VALUES ('OPEN', 'Windows2000', 'Microsoft', 400, '23/02.02.2003');
INSERT INTO `evidenta_calculatoare_licente`.`licenta` (`tip`, `produs`, `producator`, `valoare`, `document`) VALUES ('Free', '7zip', 'XXX', 0, 'NA');


INSERT INTO `evidenta_calculatoare_licente`.`angajat_calculator` (`id_angajat`, `id_calculator`) VALUES ('1', '1');
INSERT INTO `evidenta_calculatoare_licente`.`angajat_calculator` (`id_angajat`, `id_calculator`) VALUES ('2', '2');
INSERT INTO `evidenta_calculatoare_licente`.`angajat_calculator` (`id_angajat`, `id_calculator`) VALUES ('1', '3');
INSERT INTO `evidenta_calculatoare_licente`.`angajat_calculator` (`id_angajat`, `id_calculator`) VALUES ('3', '4');


INSERT INTO `evidenta_calculatoare_licente`.`calculator_licenta` (`id_calculator`, `id_licenta`) VALUES ('1', '1');
INSERT INTO `evidenta_calculatoare_licente`.`calculator_licenta` (`id_calculator`, `id_licenta`) VALUES ('1', '3');
INSERT INTO `evidenta_calculatoare_licente`.`calculator_licenta` (`id_calculator`, `id_licenta`) VALUES ('2', '2');
